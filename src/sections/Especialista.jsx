          ...
          <FadeIn delay={0.2}>
            <div className="mt-8 flex justify-center md:justify-start">
              <Button asChild variant="gold" className="font-bold">
                <a href="https://api.whatsapp.com/send/?phone=5585994326619&text=Ol%C3%A1%21+Vim+do+site+de+dor+no+joelho+e+gostaria+de+agendar+uma+consulta&type=phone_number&app_absent=0." aria-label="Agendar avaliação com o especialista" target="blank">
